    ...
    <main className="bg-beige-50 min-h-screen py-12 px-4">
      <div className="container mx-auto max-w-4xl">
              ...
              <CardContent>
                      ...
                      <div key={item.id} className="py-4 flex items-center gap-4">
                        ...
                        <div className="flex-1">
                          <p className="font-medium text-beige-800">
                            {item.product?.name || 'Producto ' + item.product_id.slice(-6)}
                          </p>
                ...
                <div className="border-t border-beige-200 mt-4 pt-4">
                  <div className="flex justify-between py-2">
                    ...
                    <p className="font-medium text-beige-800">${calculateOrderTotal(order)}</p>
                  </div>
                  <div className="flex justify-between py-2">
            ...
            <Card className="bg-white border-beige-200 shadow-sm">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    <p className="text-sm font-medium text-beige-700">Método de Pago:</p>
                    <p className="text-beige-600">
                  ...
                  <div>
                    <p className="text-sm font-medium text-beige-700">Dirección de Envío:</p>
                    <p className="text-beige-600">
        ...
        <div className="mt-8 flex gap-4 justify-end">
          <Button variant="outline" className="border-beige-200 text-beige-800 hover:bg-beige-100">
            Cancelar Pedido
          </Button>
