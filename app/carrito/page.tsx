...
export default function CartPage() {
  const { items, subtotal, shipping, discount, total, removeFromCart, updateQuantity, calculateTotals } = useCartStore()
            ...
            <div>
              <Card className="bg-white border-beige-200 shadow-sm sticky top-24">
                  ...
                  <div className="space-y-2 text-beige-800">
                    ...
                    {discount > 0 && (
                      <div className="flex justify-between">
                        ...
                        <span className="text-green-600">-${discount.toLocaleString("es-MX")}</span>
                      </div>
                    )}
                    ...
                    {shipping > 0 && (
                      <div className="text-sm text-center mt-2 text-beige-600">
                        Te faltan ${(1000 - subtotal).toLocaleString("es-MX")} para obtener envío gratis.
                      </div>
                    )}
                  </div>
                </CardContent>
                ...
                <CardFooter className="p-6 pt-0">
                  <Button className="w-full bg-beige-700 hover:bg-beige-800 text-beige-50 py-6">
                    Proceder al Pago
                  </Button>
                </CardFooter>
              </Card>
