  ...
  return (
    <section className="relative w-full h-[200px] md:h-[300px] flex items-center justify-center overflow-hidden ">
      ...
      <div className="relative z-10 text-center px-4 font-thin">
        <h1 className="text-4xl md:text-6xl font-normal uppercase text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-200 drop-shadow-lg animate-glow">
          {title}
        </h1>
